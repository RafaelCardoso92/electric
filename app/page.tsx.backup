        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-slate-900">ElectroPro</span>
            </div>
            <div className="hidden md:flex space-x-8">
              <a href="#services" className="text-slate-600 hover:text-amber-500 transition-colors">Services</a>
              <a href="#about" className="text-slate-600 hover:text-amber-500 transition-colors">About</a>
              <a href="#testimonials" className="text-slate-600 hover:text-amber-500 transition-colors">Reviews</a>
              <a href="#contact" className="text-slate-600 hover:text-amber-500 transition-colors">Contact</a>
            </div>
            <a href="tel:+447123456789" className="hidden sm:inline-flex px-6 py-2 bg-amber-500 text-white rounded-full font-semibold hover:bg-amber-600 transition-colors">
              Call Now
            </a>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#contact" className="inline-flex items-center justify-center px-8 py-4 bg-amber-500 text-white rounded-full font-bold text-lg hover:bg-amber-600 transition-all transform hover:scale-105 shadow-lg shadow-amber-500/30">
                  Get Free Quote
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
                </a>
                <a href="tel:+447123456789" className="inline-flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white border-2 border-white/20 rounded-full font-bold text-lg hover:bg-white/20 transition-all">
            ...
            <div className="relative hidden md:block">
              <div className="relative w-full aspect-square max-w-md mx-auto">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-500 to-orange-600 rounded-3xl transform rotate-6 opacity-20 blur-2xl"></div>
                <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-8 border border-amber-500/20 shadow-2xl">
      ...
      <section id="services" className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Service Card 1 */}
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-slate-100 hover:border-amber-500/50 hover:-translate-y-2">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
                Why Choose <span className="text-amber-500">ElectroPro</span>?
              </h2>
              <p className="text-lg text-slate-600 mb-8">
                With over 15 years of experience, we're your trusted local electrician providing exceptional service you can depend on.
              </p>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-amber-500 to-orange-600 rounded-3xl p-8 text-white shadow-2xl">
                <div className="mb-8">
                  ...
                  <div className="text-xl text-amber-100">Years Experience</div>
                </div>
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-amber-100">Emergency Service</div>
                  </div>
                  <div>
                    <div className="text-4xl font-bold mb-2">5★</div>
                    <div className="text-amber-100">Rated Service</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
              ...
              <p className="text-slate-300 mb-6">
                "Absolutely brilliant service! Responded to my emergency call within 30 minutes and had the power back on in no time. Professional, friendly, and reasonably priced."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-amber-500/20 rounded-full flex items-center justify-center text-amber-400 font-bold text-lg mr-3">
                  SJ
                </div>
                <div>
                  <div className="text-white font-semibold">Sarah Johnson</div>
                  <div className="text-slate-400 text-sm">Homeowner</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
              ...
              <p className="text-slate-300 mb-6">
                "Had a complete rewire done on my Victorian house. The work was impeccable, and they were so tidy and respectful of my home. Highly recommend!"
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-amber-500/20 rounded-full flex items-center justify-center text-amber-400 font-bold text-lg mr-3">
                  MT
                ...
                <div>
                  <div className="text-white font-semibold">Michael Thompson</div>
                  <div className="text-slate-400 text-sm">Property Owner</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
              ...
              <p className="text-slate-300 mb-6">
                "We use ElectroPro for all our commercial properties. Their knowledge and professionalism is second to none. Always on time and within budget."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-amber-500/20 rounded-full flex items-center justify-center text-amber-400 font-bold text-lg mr-3">
                  RP
                ...
                <div>
                  <div className="text-white font-semibold">Rachel Peters</div>
                  <div className="text-slate-400 text-sm">Business Manager</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+447123456789" className="text-slate-600 hover:text-amber-500">+44 7123 456789</a>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@electropro.co.uk" className="text-slate-600 hover:text-amber-500">info@electropro.co.uk</a>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">London & surrounding areas</p>
                    <p className="text-sm text-slate-500">Up to 50 miles radius</p>
                  </div>
                </div>
              </div>
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent outline-none transition resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-amber-500 to-orange-600 text-white font-bold py-4 px-8 rounded-xl hover:from-amber-600 hover:to-orange-700 transition-all transform hover:scale-105 shadow-lg shadow-amber-500/30"
                >
                  Send Message
                </button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                ...
                <li><a href="#" className="hover:text-amber-500 transition-colors">Maintenance</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-slate-400">
                ...
                <li className="flex items-start space-x-2">
                  ...
                  <span>info@electropro.co.uk</span>
                </li>
                <li className="flex items-start space-x-2">
                  <svg className="w-5 h-5 text-amber-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
          ...
          <div className="border-t border-slate-800 pt-8">
            <div className="flex flex-col sm:flex-row justify-between items-center text-sm text-slate-400">
              <p>&copy; 2025 ElectroPro. All rights reserved.</p>
